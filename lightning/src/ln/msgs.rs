...
/// padding size corresponding to constant message size excluding MACs, lenght field and message type field
pub const LN_CONST_PADDING_LEN: usize = LN_CONST_MSG_LEN - 2 * 16 - 2 - 2;
...
/// A [`padding`] message to be sent to or received from a peer
///
/// [`padding`]: dummy message used for creating cover traffic against traffic analysis
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct PaddingMessage {
	/// The dummy data padding
	pub padding: [u8; LN_CONST_PADDING_LEN],
}
...
pub trait ChannelMessageHandler: MessageSendEventsProvider {
	...
	/// Padding message without any further functionality
	fn handle_padding_msg(&self, their_node_id: &PublicKey, msg: &PaddingMessage);
}
...
impl_writeable_msg!(PaddingMessage, { padding }, {});
...
mod tests {
	...
	use crate::routing::gossip::{NodeAlias, NodeId};
	use crate::util::ser::{
		BigSize, FixedLengthReader, Hostname, LengthReadable, Readable, ReadableArgs,
		TransactionU16LenLimited, Writeable,
	};
	...
	fn encoding_final_onion_hop_data_with_trampoline_packet() {
...

		{
			...
			let mut trampoline_packet_reader =
				FixedLengthReader::new(&mut reader, encoded_trampoline_packet.len() as u64);
			let decoded_trampoline_packet: TrampolineOnionPacket =
				<TrampolineOnionPacket as LengthReadable>::read(&mut trampoline_packet_reader)
					.unwrap();
	...
	#[test]
	fn encoding_padding_msg() {
		let padding: [u8; LN_CONST_PADDING_LEN] = [1; LN_CONST_PADDING_LEN];
		let pm = msgs::PaddingMessage { padding };
		let encoded_value = pm.encode();
		let target_value = <Vec<u8>>::from_hex("").unwrap();
		assert_eq!(encoded_value, target_value);
	}
